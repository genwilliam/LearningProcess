...
- [shell（pdf)](Linux/Shell.pdf) 或者 [shell（md)](Linux/Shell.md)
...
- [Coding Interview University](Github/Coding%20Interview%20University.md)
...
- [awesome-dotfiles](Github/dotfiles.md)

一个高质量的 dotfiles 资源导航仓库，覆盖入门文章、示例仓库与管理工具，适合系统学习如何把开发环境做成可迁移、可复用的工程化配置。
